...
<ul>
	<li>For example, if there are <code style="">4</code> candies with costs <code style="">1</code>, <code style="">2</code>, <code style="">3</code>, and <code style="">4</code>, and the customer buys candies with costs <code style="">2</code> and <code style="">3</code>, they&nbsp;can take the candy with cost <code style="">1</code> for free, but not the candy with cost <code style="">4</code>.</li>
</ul>

<p>Given a <strong>0-indexed</strong> integer array <code style="">cost</code>, where <code style="">cost[i]</code> denotes the cost of the <code style="">i<sup>th</sup></code> candy, return <em style="">the <strong>minimum cost</strong> of buying <strong>all</strong> the candies</em>.</p>

<p>&nbsp;</p>
<p><strong>Example 1:</strong></p>

<pre style=""><strong>Input:</strong> cost = [1,2,3]
...
<pre style=""><strong>Input:</strong> cost = [6,5,7,9,2,2]
...
<pre style=""><strong>Input:</strong> cost = [5,5]
...
<ul>
	<li><code style="">1 &lt;= cost.length &lt;= 100</code></li>
	<li><code style="">1 &lt;= cost[i] &lt;= 100</code></li>
</ul>
</div>